...
export function CTASection() {
  return (
    <Reveal className="rounded-3xl border border-gold-500/30 bg-gradient-to-r from-olive-900/90 via-forest-900/80 to-gold-600/20 px-8 py-12 text-center shadow-gold">
